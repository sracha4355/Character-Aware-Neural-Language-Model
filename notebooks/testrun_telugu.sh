#!/bin/bash
#SBATCH --job-name=nlp_ga_telugu            # Job name to appear in the SLURM queue
...
#SBATCH --error=telugu_batch_error.err           # Standard error log file
#SBATCH --output=telugu_batch_output.out           # Standard error log file
...
python3 character_aware_neural_language_non_english_language.py > telugu_model_output.txt 
